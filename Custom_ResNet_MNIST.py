...
scheduler = CosineScheduler(
    max_update = 80, base_lr = 0.03,
    final_lr = 0.0001, warmup_steps = 10,
...
for epoch in range(num_epochs):
    ...
    if (test_acc > best_test_acc):
        ...
        torch.save(model.state_dict(), "ConvResNet_best_model.pth")


# Save training metrics as Python3 dict for later analysis-
with open("ConvResNet_MNIST_train_history.pkl", "wb") as file:
